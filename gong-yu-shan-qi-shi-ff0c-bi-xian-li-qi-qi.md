...
這個文字編輯器是一個非常輕巧簡單的編輯器，最初是由windows api 以及C++ STL寫成的，如今也支援各個平台，這個編輯器沒有上述兩個編輯器比較複雜的功能，最初的理念是取代微軟的內建文字編輯器Nodepad，所以不難看出他的命名為什麼會叫做Nodepad++了，這個編輯器主打優化函數及演算法，並致力於減少世界二氧化碳的排放。當使用較少的 CPU 功率，降低電腦系統能源消耗，Notepad++ 也就間接綠化了我們的環境。
