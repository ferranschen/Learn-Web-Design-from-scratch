...
> 在寫程式之前，你必須準備寫程式的文字編輯器（Text Editor），你可以使用 Windows 上的 Notepad (記事本)，或是 Mac 上的 TextEdit，這兩個編輯器用來寫初學的網站已經足夠了。以下我推薦幾個專業的文字編輯器，免費而且功能卻非常強大。您也可選擇其他編輯器，只要能編輯成功就行了。
